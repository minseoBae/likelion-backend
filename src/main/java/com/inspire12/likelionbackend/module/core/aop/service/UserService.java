...
public class UserService {
    ...
    public void registerUser(String username, String email) {
        // 로깅
        long start = logStartExecutionTime(username);
        ...
        // 로깅
        logEndExecutionTime(username, start, System.currentTimeMillis());
    }

    private long logStartExecutionTime(String username) {
    ...
    private void logEndExecutionTime(String username, long start, long end) {
        // TODO registerUser 에서 로깅을 담당하는 파트를 담는다
